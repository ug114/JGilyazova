    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                matrix3 = new Matrix(new double[,] { { 1, 2 }, { 3, 4 } });

                v1 = new Vector(new double[] { 1 });
            ...
            Console.WriteLine("Матрица: {0}, транспонированная матрица: {1}.", matrix3.ToString(), matrix3.Transpose().ToString());
